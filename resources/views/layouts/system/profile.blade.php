             ...
             <div class="card">
              ...
              <div id="tab1" class="col s12">
                ...
                <div class="col-xs-12 col-sm-6 col-md-5" style="text-align: right; padding: 0;">
                  ...
                  <div id="foto_perfil" style="cursor: pointer; opacity: 1; color: #ffffff; font-size: 35px; text-align: center; background: url('{{Auth::user()->X_UFOTO}}'), url('{{ url('assets/img/system/perfil_default.png') }}') no-repeat scroll center center / 100% 100%; max-width: 300px; width:80%; height:80%;" data-position="top" id="">
                    ...
                    <div style="background: rgba(0,0,0,0.5);width: 100%;height: 100%;">
                      ...
                      <p style="margin-top: -10px; font-family: lato-bold;">@Lang('messages.changePicture')</p>
                      <p style="margin-top: -10px; font-family: lato-bold;">@Lang('messages.changePicture2')</p>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6" style="text-align: left; padding: 0;">
                  ...
                  <input style="border: 1px solid #26a8ff; height: 30px; font-size: 13px; color: #5e5e5e; padding-left: 10px; height: 36px; width: 80%; border-radius: 4px; margin-bottom:10px;" type="text" class="form-control" value="{{Auth::user()->name}}" aria-describedby="sizing-addon1" id="nombre52">

                  <p style="font-size: 16px; color:#a3a3a3">@Lang('messages.emailProfile')</p>
                  <input style="border: 1px solid #26a8ff; height: 30px; font-size: 13px; color: #5e5e5e; padding-left: 10px; height: 36px; width: 80%; border-radius: 4px; margin-bottom:10px;" type="text" class="form-control" value="{{Auth::user()->email}}" aria-describedby="sizing-addon1" id="mail52">
           
                  <p style="font-size: 16px; color:#a3a3a3">@Lang('messages.zonaHorarioProfile')</p>
                  <select style="border: 1px solid #26a8ff; height: 30px; font-size: 13px; color: #5e5e5e; padding-left: 10px; height: 36px; width: 80%; border-radius: 4px; margin-bottom:10px; display: block; !important" id="timezone" name="timezone" required>
                  ...
                  <select style="border: 1px solid #26a8ff; height: 30px; font-size: 13px; color: #5e5e5e; padding-left: 10px; height: 36px; width: 80%; border-radius: 4px; margin-bottom:10px; display: block; !important" id="language" name="language" required>
                  ...
                  <p ng-click="olvidastePass()" style="font-size: 16px; color:#26a8ff; cursor: pointer; width:190px;">@Lang('messages.olvidasteProfile')</p>
                  ...
                  <a class="waves-effect waves-light btn" style="background-color:#26A8FF; width:250px;" ng-click="guardarCambiosProfile();">@Lang('messages.saveChangesProfile')</a>
